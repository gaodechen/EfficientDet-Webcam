##
# Repo Name: EfficientDeg-Webcam
# Repo Address: https://github.com/gaodechen/EfficientDet-Webcam
# Author: Gao Dechen
##
...
def display(cam_addrs, window_names, img_shape=(512, 512)):
...
def display_single_window(cam_addrs, window_name='camera',  img_shape=(512, 512)):
    raw_queues = [mp.Queue(maxsize=2) for _ in cam_addrs]
    pred_queues = [mp.Queue(maxsize=4) for _ in cam_addrs]
    processes = []
